...
lib.ssMetadata = [
		...
		{name:"Take Coin_atlas_3", frames: [[0,0,1080,1920],[1082,0,540,960],[1082,962,540,960]]},
		{name:"Take Coin_atlas_4", frames: [[443,374,282,63],[0,0,635,254],[0,374,441,145],[759,92,224,64],[759,0,208,90],[443,439,342,42],[727,374,120,21],[727,397,26,26],[0,256,861,116],[969,0,46,46],[863,361,96,104],[863,247,144,112],[637,194,381,51],[637,0,120,192],[985,132,16,48],[985,90,24,40],[969,48,40,40]]}
];
...
(lib.TakeCoin = function(mode,startPosition,loop) {
	...
	this.instance_2.parent = this;
	this.instance_2.setTransform(270,480,1,1,0,0,0,0,-480);
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(1).to({_off:false},0).wait(12).to({alpha:0},10).to({_off:true},1).wait(13));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.title_mc}]}).to({state:[]},1).to({state:[{t:this.coin1},{t:this.coin2},{t:this.coin4},{t:this.coin5},{t:this.coin3}]},23).wait(13));

	// 圖層_4
	this.instance_3 = new lib.Landscape_Layer1();
	this.instance_3.parent = this;
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(13).to({_off:false},0).wait(24));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.Cloud_3},{t:this.Cloud_2},{t:this.Cloud_4},{t:this.Cloud_1}]},13).wait(24));

	// 圖層_3
	this.instance_4 = new lib.Landscape_Layer2();
	this.instance_4.parent = this;
	this.instance_4.setTransform(0,38,1,0.9604);
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(13).to({_off:false},0).wait(24));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(13).to({_off:false},0).wait(24));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-120.9,368.8,874.1999999999999,591.2);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/Take Coin_atlas_.png?1641272629385", id:"Take Coin_atlas_"},
		{src:"images/Take Coin_atlas_2.png?1641272629385", id:"Take Coin_atlas_2"},
		{src:"images/Take Coin_atlas_3.png?1641272629385", id:"Take Coin_atlas_3"},
		{src:"images/Take Coin_atlas_4.png?1641272629386", id:"Take Coin_atlas_4"}
	],
	preloads: []
};
